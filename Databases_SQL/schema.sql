...
(9, '122, Pineapple Avenue, New York', 'Michael Carlos', 'USA', 'Open Soon');
...
--
ALTER TABLE `Campus`
  MODIFY `CaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `Module`
  MODIFY `ModuleID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `Activity`
  ...
  ADD CONSTRAINT `Activity_ibfk_2` FOREIGN KEY (`BuID`) REFERENCES `Budget` (`BuID`) ON DELETE CASCADE ON UPDATE CASCADE;
